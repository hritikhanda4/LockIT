...
public class changeSettingsPasswordSceneController implements Initializable  {
    @FXML
    Button newBtn,resetBtn,aboutBtn,changeBtn,changeSettingsChangePasswordBtn,changeSettingsChangeImeiBtn,changeSettingsChangePeriodBtn,passwordLockBtn;
    @FXML
    TextField oldPassword,newPassword;
    @Override
    public void initialize(URL location, ResourceBundle resources) {
        ...
        passwordLockBtn.setOnAction(event -> {
          ...
          //Data retrieval
            ...
            {
            	if(newPass.length()>=1) {
            		    WriteData.writeData(retreivedImei, newPass, retreivedPeriod);
